...
%% La seguente definizione di query la integrerei nella prima parte dell'introduzione dove parliamo di query. 
%% To retrieve pieces of information from the database, it is important to introduce the concept of query, which is a set of conditions that filter the database and return only the needed data.
